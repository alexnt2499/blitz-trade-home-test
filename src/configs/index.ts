import { ITokenSwitchEnv } from "@/interfaces/Token";
import { AbiItem } from "web3-utils";

export const TokenABI: AbiItem | AbiItem[] = [
...
export const JsonRpcUrl: string =
  "https://mainnet.infura.io/v3/16a58b4fcc1840d0ad7d7a5ac746d501";

export const Tokens: ITokenSwitchEnv = {
  main_net: [
    {
      name: "USDT",
...
export const exportFileName = `wallets-info-${new Date()
  .toISOString()
  .replace(".", "-")}.csv`;
